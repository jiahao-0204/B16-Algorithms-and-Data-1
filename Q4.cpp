 ...
 * ? 1.4 Queues
 * 
 * ? 1.4.1 Enhanced queue class
 * ? Starting from the class Queue given in the notes, create a new stack class Dequeue 
 ...
 * ? 3. A member function dequeue_front to remove elements from the front of the queue. 
